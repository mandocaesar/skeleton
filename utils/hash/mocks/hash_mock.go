...
func (_m *Hash) HashPassword(password string) (string, error) {
...
// IsPasswordHash provides a mock function with given fields: password, _a1
func (_m *Hash) IsPasswordHash(password string, _a1 string) bool {
